...
def move_file(file_info: FileInfo, destination_dir: str, create_log: bool = False, 
              error_message: str = None, error_details: Dict[str, Any] = None) -> Optional[str]:
    """
...
def process_file_with_error_handling(manager, file_info: FileInfo, 
                                     processed_dir: str, failed_dir: str) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        if processing_result["status"] == "success":
            ...
            if (
                ...
                error_message = "Processing failed due to missing required items"
            else:
